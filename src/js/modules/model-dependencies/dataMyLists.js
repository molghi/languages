...
const myListVocab2 = [
    ...
    "You do not have a new book.",
    "He does not like eating pizza.",
    "We are not going to Berlin.",
    "They are not learning German.",
    ...
    "Vergelt’s Gott",
    "Pfiat di",
    "Entschuldigung (often 'Schuidigung')",
    "I bin müd",
    "Gehma",
    "Jo",
    "Na",
